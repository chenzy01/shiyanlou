...
def iter_courses():
    ahthor = User.query.filter_by(username='Jack Lee').first()
    ...
    for course in Course.query:
        for i in range(randint(3,10)):
            yield Chapter(
                    name=fake.sentence(),
                    course=course,
                    veido_url='https://labfile.oss.aliyuncs.com/courses/923/week2_mp4/2-1-1-mac.mp4',
                    vedio_duration='{}:{}'.format(randint(10,30),randingt(10,59))
                    )
